...
<i class="fa-solid fa-code text-secondary"></i> In my free time, I am also an amateur webmaster. This site was coded by hand without the use of generative AI, utilizing 11ty (Static Site Generator), Nunjucks, and hosted on Github Pages. Other features include Bootstrap (CSS), and icons from FontAwesome.